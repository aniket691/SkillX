...
public class PhoneAuthAct extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onStart() {
        ...
        if (currentUser != null) {
            ...
            Toast.makeText(PhoneAuthAct.this, "Currently Logged in: " + currentUser.getEmail(), Toast.LENGTH_LONG).show();
